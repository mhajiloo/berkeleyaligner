...
public class Alignment implements Serializable {
	...
	public Alignment(Alignment al) {
		this(al.englishSentence, al.foreignSentence);
	}
	...
	private void gatherAlignmentArrays() {
		foreignAlignments = new ArrayList<List<Integer>>(foreignSentence.size());
		for (int i = 0; i < foreignSentence.size(); i++) {
			foreignAlignments.add(new ArrayList<Integer>());
		}
		englishAlignments = new ArrayList<List<Integer>>(englishSentence.size());
	...
	public Alignment intersect(Alignment a) {
		Alignment ia = new Alignment(englishSentence, foreignSentence);
	...
	public Alignment union(Alignment a) {
		Alignment ua = new Alignment(englishSentence, foreignSentence);
		for (Pair<Integer, Integer> p : sureAlignments)
	...
	public Alignment reverse() {
		Alignment a2 = new Alignment(foreignSentence, englishSentence);
		for (Pair<Integer, Integer> p : sureAlignments)
